jQuery(document).ready(function ($) {
    $('.ms-gradient-box').each(function () {
        var $pickerId = $(this).find('.ms-gradient-picker');
        var $inputId = $(this).find('.ms-gradient-val');
        var $previewId = $(this).find('.ms-gradient-preview');
        var $directionId = $(this).find('.ms-gradient-direction');
        var $customGradId = $(this).find('.ms-gradient-custom')
        ...
        $directionId.on("change", function () {
            ...
            if (direction == 'custom') {
                ...
                orientation = $(this).closest('.ms-gradient-box').find('.ui-slider-handle > span').text();
        ...
        $(this).find('.ms-gradient-range').slider({
            range: "min",
            value: deg,
            min: 0,
            max: 360,

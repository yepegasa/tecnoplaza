...
<?php } 
        ...
        ?>
        <div>
            <label for=""><input type="radio" value="pad" <?php echo $settings['crop_mode'] === 'pad' ? 'checked':'' ?> name="wp_sir_settings[crop_mode]">Resize without cropping (default)<span class="wp-sir-help-tip" title="This option will scale the images to fit within the selected sizes while maintaining the original aspect ratio. This is a good option if you want to preserve the full view of the image, but may result in some white space on the sides or top/bottom of the image if the original aspect ratio is different from the selected sizes"></span></label>&nbsp;&nbsp;
            <label for=""><input type="radio" value="fill" <?php echo $settings['crop_mode'] === 'fill' ? 'checked':'' ?> name="wp_sir_settings[crop_mode]">Resize with cropping<span class="wp-sir-help-tip" title="This option will resize the images to fit within the selected sizes by cropping the edges of the image as needed to maintain the aspect ratio. This is a good option if you want all of your images to be the same size and shape, and don't mind losing some parts of the original image."></span></label>
        </div>
        <?php
        }
